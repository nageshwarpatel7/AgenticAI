...
if api_key:
    llm = ChatGroq(groq_api_key=api_key, model_name= "llama-3.3-70b-versatile") #llama-3.3-70b-versatile
    #chat interface
    ...
    ## Split and create embeddings for the documents
        ...
        contextualize_q_system_prompt = (
            ...
            "just reformulate it if needed and otherwise reture it as is."        
        )
        ...
        history_aware_retrieval = create_history_aware_retriever(llm, retriever, contextualize_q_prompt)
        ...
        rag_chain = create_retrieval_chain(history_aware_retrieval, question_answer_chain)
